...
public class QicheCollectionView extends QicheCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String qicheCollectionValue;
	...
	public QicheCollectionView() {

	}

	public QicheCollectionView(QicheCollectionEntity qicheCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, qicheCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getQicheCollectionValue() {
				return qicheCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setQicheCollectionValue(String qicheCollectionValue) {
				this.qicheCollectionValue = qicheCollectionValue;
			}
